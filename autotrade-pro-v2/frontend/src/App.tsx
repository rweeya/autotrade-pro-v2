...
const SYMBOLS = [
  ...
  'PORTAL/USDT', 'AI/USDT', 'BOME/USDT', 'TURBO/USDT', 'MEME/USDT', 'BANANA/USDT',
  'RARE/USDT', 'BB/USDT', 'IO/USDT', 'PIXEL/USDT', 'SAGA/USDT', 'DYM/USDT',
  'OMNI/USDT', 'REZ/USDT', 'ETHFI/USDT', 'STRK/USDT', 'GMX/USDT', 'LRC/USDT',
  'SUPER/USDT', 'MINA/USDT', 'YGG/USDT', 'CKB/USDT', 'SUSHI/USDT', 'THETA/USDT',
  'APE/USDT', 'BAL/USDT', 'ENJ/USDT', 'HOT/USDT', 'JASMY/USDT', 'KDA/USDT',
  'MAGIC/USDT', 'OCEAN/USDT', 'QNT/USDT', 'RVN/USDT', 'SKL/USDT', 'STORJ/USDT',
  'UMA/USDT', 'WOO/USDT', 'ZIL/USDT', 'ZRX/USDT', 'ANKR/USDT', 'ANT/USDT',
  'ASTR/USDT', 'BAND/USDT', 'CELR/USDT', 'DENT/USDT', 'DYDX/USDT', 'GLMR/USDT',
  'ICX/USDT', 'IOST/USDT', 'IOTX/USDT', 'JOE/USDT', 'KNC/USDT', 'LINA/USDT',
  'LPT/USDT', 'MOVR/USDT', 'NKN/USDT', 'OGN/USDT', 'OM/USDT', 'ONT/USDT',
  'PERP/USDT', 'POWR/USDT', 'REN/USDT', 'ROSE/USDT', 'SFP/USDT', 'SPELL/USDT',
  'SSV/USDT', 'SXP/USDT', 'TRB/USDT', 'TRU/USDT', 'VRA/USDT', 'WAXP/USDT'
];
